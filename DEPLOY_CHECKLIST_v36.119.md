...
4. Confirm the deployed `sw.js` uses cache key `hybrid-training-v36-119-secondary-frequency1`. This cache revision forces the corrected runtime/assets into a fresh service-worker cache without changing the persisted app-data schema.
