/* Hybrid Training v36.132: personalized calibration and legacy swim-data migration. */
((root)=>{
'use strict';
const VER='36.132',LEGACY_SWIM='hybridSwimMetadataV36120',PREDICTION_VERSION=4;
const FEEL={
...
const isCardio=r=>!!r&&(typeof r.modelConditioning==='boolean'?r.modelConditioning:(r.conditioning||String(r.session||'').toLowerCase()==='conditioning'||CARDIO.test(r.exercise||'')));
...
refresh();console.info('[Hybrid v36.132] personalization layer active');
