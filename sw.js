const BUILD="36.117";
const CACHE="hybrid-training-v36-117";
const FALLBACK="./index.html?v=36.117";
const REQUIRED_PRECACHE=[
  FALLBACK,
  "./manifest-v36.webmanifest?v=36.117",
  "./app-shell-v36.117.css?v=36.117",
  "./app-shell-v36.117.js?v=36.117"
];
