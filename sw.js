const BUILD="36.116";
const CACHE="hybrid-training-v36-116";
const FALLBACK="./index.html?v=36.116";
const REQUIRED_PRECACHE=[
  FALLBACK,
  "./manifest-v36.webmanifest?v=36.116",
  "./app-shell-v36.116.css?v=36.116",
  "./app-shell-v36.116.js?v=36.116"
];
