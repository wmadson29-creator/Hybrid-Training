const BUILD="36.110";
const CACHE="hybrid-training-v36-109";
const FALLBACK="./index.html?v=36.110";
const REQUIRED_PRECACHE=[
  FALLBACK,
  "./manifest-v36.webmanifest?v=36.110",
  "./app-shell-v36.110.css?v=36.110",
  "./app-shell-v36.110.js?v=36.110"
];
